...
//        managerFactory.close();
        ...
        entityManager.getTransaction().begin();
        JuegoEntidad juego = new JuegoEntidad("Evil Mojo", "Paladins");
        
        LogroEntidad logro2 = new LogroEntidad("Gana una partida", "50", juego);
        LogroEntidad logro1 = new LogroEntidad("Gana dos partidas", "100", juego);
        ...
        juego.setListaLogros(listaLogros);
