...
//        JuegoEntidad juego = new JuegoEntidad("Evil Mojo", "Paladins", new GregorianCalendar(2018, 4, 8), listaLogros);
//
...
//        JuegoEntidad juegoNuevo = new JuegoEntidad("NetherRealm Studios", "Mortal Kombat", new GregorianCalendar(2022, 0, 15), listaLogros);
//
